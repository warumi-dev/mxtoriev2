        ...
        await CmdExist(database, message, this.help.name).then(async () => {
            await database.query("SELECT * FROM commands WHERE serverid = ? AND name = ?", [message.guild.id, this.help.name], async (error, result) => {
                ...
                try {
                    ...
                    if (!serverQueue) return sendError("Il n'y a aucune musique que je peux arrêter.", message.channel);
...
module.exports.help = {
    name: "stop",
    aliases: [`dc`],
    desc: ["Arrête la musique et vide la file d'attente", "Stop the music and clear the queue"],
    access_member: [""],
