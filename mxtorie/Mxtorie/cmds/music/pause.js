                ...
                try {
                    ...
                    if (serverQueue && serverQueue.playing) {
                        ...
                        try {
                            ...
                            return sendError(`:notes: La musique a été arrêter et la file d'attente vidé : ${error}`, message.channel);
                        }
                        let xd = new MessageEmbed()
                            .setDescription("⏸ Musique en pause !")
                            .setColor("YELLOW")
                        //.setTitle("Music has been paused!")
                        return message.channel.send(xd);
                    }
                    return sendError("Aucune musique n'est entrain d'être jouer.", message.channel);
...
module.exports.help = {
    name: "pause",
    aliases: [`pau`],
    desc: ["Mettre la musique en pause", "Pause the current music"],
    access_member: [""],
