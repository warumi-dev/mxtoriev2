        ...
        await CmdExist(database, message, this.help.name).then(async () => {
            await database.query("SELECT * FROM commands WHERE serverid = ? AND name = ?", [message.guild.id, this.help.name], async (error, result) => {
                ...
                try {
                    ...
                    if (message.member.roles.highest.position < role.position && !config.owner.includes(message.author.id) && config.buyer != message.author.id) return message.reply(lang.by == "by" ? "This role is above you." : "Ce rôle est au dessus de toi.")
...
module.exports.help = {
    ...
    usage: ["role add <mention> <rôle/id>", "role remove <mention> <rôle/id>"],
